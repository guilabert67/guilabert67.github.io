...
export const textos = {
  es: {
    ...
    loUltimo: 'Lo último',
    sinNovedadHoy: 'Todavía no hay nada nuevo de hoy. La próxima edición sale {cuando}.',
    losCursos: 'Cursos',
    filtrarCursos: 'Filtrar los cursos',
    quienLoDa: 'Quién lo da',
    modalidad: 'Cómo',
    duracion: 'Duración',
    plazas: 'Plazas',
    inscripcionHasta: 'Plazo para apuntarse',
    empieza: 'Empieza',
    plazoInscripcionCerrado: 'Plazo cerrado',
    comoApuntarseCurso: 'Cómo apuntarse →',
    dasCursos: '¿Das clases o algún curso?',
    comoPublicarCurso: 'Publicar un curso aquí es gratis: da igual que seas el ayuntamiento, una academia o alguien que enseña lo que sabe. Mándanos qué enseñas, cuándo, dónde y hasta cuándo se puede uno apuntar.',
    dondeBuscarCursos: 'Dónde se publican más cursos',
    dondeBuscarCursosPie: 'Los sitios oficiales donde salen los cursos públicos. No caducan, así que aquí hay algo que mirar aunque esta semana no haya nada nuevo.',
    cursosEnPrensa: 'Cursos de los que se ha hablado',
    sinCursos: 'Ahora mismo no hay cursos abiertos. En cuanto salga alguno, aparece aquí.',
    elTablon: 'El tablón',
    ...
    // Las ediciones se nombran, no se fechan a la hora: ver src/config.mjs.
    edicionManana: 'Edición de la mañana',
    edicionMediodia: 'Edición del mediodía',
    edicionNoche: 'Edición de la noche',
    // Cuándo sale la SIGUIENTE, para cuando la portada aún no tiene nada.
    cuandoManana: 'mañana por la mañana',
    cuandoMediodia: 'al mediodía',
  ...
  en: {
    cursosAbiertos: 'Open courses',
    loUltimo: 'Latest',
    sinNovedadHoy: 'Nothing new from today yet. The next edition comes out {cuando}.',
    losCursos: 'Courses',
    filtrarCursos: 'Filter the courses',
    quienLoDa: 'Run by',
    modalidad: 'Format',
    duracion: 'Length',
    plazas: 'Places',
    inscripcionHasta: 'Sign up by',
    empieza: 'Starts',
    plazoInscripcionCerrado: 'Closed',
    comoApuntarseCurso: 'How to sign up →',
    dasCursos: 'Do you teach anything?',
    comoPublicarCurso: 'Listing a course here is free, whether you are the council, a training centre or someone who teaches what they know. Tell us what you teach, when, where and the deadline to sign up.',
    dondeBuscarCursos: 'Where more courses are listed',
    dondeBuscarCursosPie: 'The official places where public courses are announced. They never go out of date, so there is always something to look at.',
    cursosEnPrensa: 'Courses in the news',
    sinCursos: 'No courses open right now. As soon as one is announced, it shows up here.',
    ...
    edicionManana: 'Morning edition',
    edicionMediodia: 'Midday edition',
    edicionNoche: 'Evening edition',
    cuandoManana: 'tomorrow morning',
  ...
  fr: {
    cursosAbiertos: 'Formations ouvertes',
    loUltimo: 'Les dernières',
    sinNovedadHoy: 'Rien de neuf pour aujourd\'hui encore. La prochaine édition paraît {cuando}.',
    losCursos: 'Formations',
    filtrarCursos: 'Filtrer les formations',
    quienLoDa: 'Organisé par',
    modalidad: 'Format',
    duracion: 'Durée',
    plazas: 'Places',
    inscripcionHasta: 'Inscription jusqu\'au',
    empieza: 'Début',
    plazoInscripcionCerrado: 'Inscriptions closes',
    comoApuntarseCurso: 'Comment s\'inscrire →',
    dasCursos: 'Vous enseignez quelque chose ?',
    comoPublicarCurso: 'Publier une formation ici est gratuit, que vous soyez la mairie, un centre de formation ou quelqu\'un qui transmet son savoir. Dites-nous quoi, quand, où et jusqu\'à quand on peut s\'inscrire.',
    dondeBuscarCursos: 'Où trouver d\'autres formations',
    dondeBuscarCursosPie: 'Les sites officiels où paraissent les formations publiques. Ils ne périment pas : il y a toujours quelque chose à regarder.',
    cursosEnPrensa: 'Formations dont on a parlé',
    sinCursos: 'Aucune formation ouverte pour l\'instant. Dès qu\'il y en a une, elle paraît ici.',
    ...
    edicionManana: 'Édition du matin',
    edicionMediodia: 'Édition de midi',
    edicionNoche: 'Édition du soir',
    cuandoManana: 'demain matin',
  ...
  de: {
    cursosAbiertos: 'Offene Kurse',
    loUltimo: 'Zuletzt',
    sinNovedadHoy: 'Von heute gibt es noch nichts Neues. Die nächste Ausgabe erscheint {cuando}.',
    losCursos: 'Kurse',
    filtrarCursos: 'Kurse filtern',
    quienLoDa: 'Veranstalter',
    modalidad: 'Form',
    duracion: 'Dauer',
    plazas: 'Plätze',
    inscripcionHasta: 'Anmeldung bis',
    empieza: 'Beginn',
    plazoInscripcionCerrado: 'Anmeldung geschlossen',
    comoApuntarseCurso: 'So meldet man sich an →',
    dasCursos: 'Unterrichten Sie etwas?',
    comoPublicarCurso: 'Einen Kurs hier einzustellen ist kostenlos — ob Gemeinde, Bildungsträger oder jemand, der weitergibt, was er kann. Sagen Sie uns was, wann, wo und bis wann man sich anmelden kann.',
    dondeBuscarCursos: 'Wo es weitere Kurse gibt',
    dondeBuscarCursosPie: 'Die offiziellen Stellen, an denen öffentliche Kurse ausgeschrieben werden. Sie veralten nicht, es gibt also immer etwas zu sehen.',
    cursosEnPrensa: 'Kurse, über die berichtet wurde',
    sinCursos: 'Zurzeit sind keine Kurse offen. Sobald einer ausgeschrieben wird, steht er hier.',
    ...
    edicionManana: 'Morgenausgabe',
    edicionMediodia: 'Mittagsausgabe',
    edicionNoche: 'Abendausgabe',
    cuandoManana: 'morgen früh',
